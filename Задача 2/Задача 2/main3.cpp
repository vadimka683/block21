...
int main() {
	...
	do {
		...
		if (answer == "add") {
			...
			vect_1.input_vector(vect_1);
			Vectors vect_2;
			cout << "Input second vector: \n";
			vect_1.input_vector(vect_2);
			Vectors vect_3;
			vect_3.add(vect_1, vect_2, vect_3);
			...
			vect_1.input_vector(vect_2);
			Vectors vect_3;
			vect_3.subtract(vect_1, vect_2, vect_3);
			cout << "(" << vect_3.X << " , " << vect_3.Y << ")";
		}
			...
			cin >> num;
			Vectors vect_2;
			vect_2.scale(vect_1, vect_2, num);
		...
		else if (answer == "normalize")
		{
			...
			vect_1.input_vector(vect_1);
			Vectors vect_2;
			vect_1.normalize(vect_1, vect_2);
			cout << "(" << vect_2.X << " " << vect_2.Y << ")";
		}
		else {
			cout << "Error comand\n";
